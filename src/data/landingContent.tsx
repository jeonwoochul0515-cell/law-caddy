...
export const WORKFLOW_STEPS = [
  ...
  },
  {
    ...
    detail: "역할을 나눈 AI 넷이 판례·적법성·쟁점·확인질문을 동시에 준비합니다",
    time: "약 2분",
  },
  {
    label: "체크포인트 · 문서 생성",
...
export const PLANS: LandingPlan[] = [
  {
    ...
    price: "무료",
    period: "",
    features: ["사건 분석 월 5건", "문서 생성 월 3건", "AI 분석 4종 전체", "신용카드 없이 가입"],
    highlighted: false,
  },
  {
    name: "Pro",
...
export const FAQS = [
  {
    ...
    a: "본인이 참여한 대화를 녹음하는 것은 통신비밀보호법상 적법한 것으로 봅니다. Law-Caddy의 적법성 검증이 매 건 함께 확인하고, 수임계약서에 녹음·AI 분석 동의 조항이 들어 있어 의뢰인 동의를 함께 받습니다.",
  },
  {
    q: "AI가 작성한 문서를 바로 제출할 수 있나요?",
    a: "바로 제출은 권하지 않습니다. 모든 산출물은 변호사의 최종 검토를 전제로 한 초안입니다. Law-Caddy는 변호사의 판단을 대체하지 않고, 초안 준비에 드는 시간을 줄여주는 도구입니다.",
  },
  {
    q: "의뢰인 정보 보안은 어떻게 되나요?",
    a: "모든 데이터는 암호화되어 저장되고 변호사 본인 계정으로만 접근합니다. 운영자는 장애 대응이 필요할 때만 열람합니다. 전자서명에는 서명 시각·IP·기기 정보가 감사 기록으로 남습니다.",
  },
  {
  ...
  },
  {
    ...
    a: "전자서명법 제3조에 따라, 전자 형태라는 이유만으로 서명의 효력이 부인되지 않습니다. 서명 시점과 IP·기기 정보가 자동으로 기록되어 분쟁 시 근거 자료로 쓸 수 있습니다.",
  },
];
