    ...
    <SeoPageLayout maxWidthClass="max-w-5xl">
      ...
      <div className="grid sm:grid-cols-2 gap-5">
        {PLATFORM_FEATURES.map((feat) => (
          <div key={feat.title} className="p-6 rounded-2xl bg-white border border-[#efeeea]">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 rounded-xl bg-[#01261f]/5 flex items-center justify-center text-[#01261f]">
                {feat.icon}
              </div>
            ...
            <h2 className="text-lg font-semibold text-[#1b1c1a] mb-2">{feat.title}</h2>
