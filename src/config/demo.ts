...
/** 데모 체크포인트 질문 (useDocument 용) - 선배 변호사 멘토링 스타일 */
export const DEMO_CHECK_QUESTIONS: CheckQuestion[] = [
  {
    id: 1,
    question: "매매계약서 원본 또는 사본을 갖고 계신가요? 특약사항이 기재되어 있나요?",
    why: "계약 내용과 특약, 해제 조건 등을 정확히 파악해야 문서에 반영할 수 있습니다.",
    category: "증거확보",
    hints: ["매매계약서 사진 또는 스캔본을 첨부해 주세요", "특약사항 부분을 별도로 촬영하면 좋습니다"],
  },
  {
    id: 2,
    question: "잔금 지급 내역(계좌이체 확인서, 무통장입금증 등)을 확보하셨나요?",
    why: "대금 지급 사실을 입증하는 핵심 증거입니다. 금액, 일자, 수취인이 명확해야 합니다.",
    category: "증거확보",
    hints: ["은행 앱에서 이체내역 캡처", "통장 사본도 가능합니다"],
  },
  {
    id: 3,
    question: "매도인의 이중매매 시도를 어떻게 알게 되셨나요? 구체적인 정황이나 증거가 있나요?",
    why: "이중매매 정황은 매도인의 악의를 입증하는 중요 사실이므로 구체적 근거가 필요합니다.",
    category: "사실관계",
    hints: ["제3자의 진술, 부동산 등기부등본 변동, 중개사 증언 등", "녹음으로 상세히 설명해 주셔도 좋습니다"],
  },
  {
    id: 4,
    question: "매매계약 체결 정확한 날짜와 잔금 지급일, 소유권이전등기 약정일은 각각 언제인가요?",
    why: "이행지체 기간 산정, 지연이자 계산, 시효 확인에 필수적인 날짜입니다.",
    category: "사실관계",
    hints: ["계약서에 기재된 날짜를 정확히 확인", "기억나지 않으면 '약 O월 O일경'이라도 기재"],
  },
  {
    id: 5,
    question: "매도인에게 이행을 최고(催告)하거나 계약 해제를 통보한 적이 있나요? 서면(내용증명 등)으로 하셨나요?",
    why: "민법 제544조에 따른 이행 최고 절차 준수 여부가 계약 해제의 적법성을 좌우합니다.",
    category: "법리검토",
    hints: ["내용증명 사본이 있으면 첨부", "구두 통보만 했다면 일시와 내용을 기재"],
  },
  {
    id: 6,
    question: "해당 부동산의 정확한 주소와 등기부등본상 표시를 알려주세요.",
    why: "내용증명에 부동산을 특정하기 위해 등기부등본상 표시(소재지, 지번, 면적 등)가 필요합니다.",
    category: "사실관계",
    hints: ["등기부등본 발급(인터넷등기소)하여 첨부하면 가장 정확", "주소만이라도 기재해 주세요"],
  },
  {
    id: 7,
    question: "매도인의 정확한 성명, 주민등록번호(앞자리라도), 주소를 알고 계신가요?",
    why: "내용증명 수신인 특정과 향후 소송 시 피고 특정을 위해 반드시 필요합니다.",
    category: "절차확인",
    hints: ["계약서에 기재된 매도인 정보 확인", "주민번호 앞 6자리만이라도 확보"],
  },
  {
    id: 8,
    question: "의뢰인의 정확한 주소(주민등록상 주소)를 알려주세요.",
    why: "내용증명 발신인 주소로 기재되며, 향후 소송에서도 송달주소로 사용됩니다.",
    category: "절차확인",
    hints: ["주민등록등본 기준 주소", "실거주지가 다르면 둘 다 알려주세요"],
  },
  {
    id: 9,
    question: "매도인과의 대화 기록(카카오톡, 문자, 이메일 등)을 보관하고 계신가요?",
    why: "매도인의 이행 거부 의사, 이중매매 정황 등을 입증하는 보조 증거가 됩니다.",
    category: "증거확보",
    hints: ["카카오톡 대화 내보내기(텍스트 파일)로 저장", "주요 대화 부분 캡처"],
  },
  {
    id: 10,
    question: "이 사건에서 원하시는 결과가 무엇인가요? (계약 이행 요구 / 계약 해제 + 대금 반환 / 손해배상 등)",
    why: "의뢰인의 희망 방향에 따라 내용증명의 청구 취지와 법적 구성이 달라집니다.",
    category: "전략수립",
    hints: ["합의 우선인지, 소송 불사인지도 함께 알려주세요", "급한 정도(시급성)도 중요합니다"],
  },
];
